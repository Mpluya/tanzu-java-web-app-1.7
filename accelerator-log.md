...
{
  "bsGitBranch" : "main",
  "projectName" : "tanzu-java-web-app-1-7-azure",
  "buildTool" : "maven",
  ...
  "bsGitRepository" : "github.com?owner=Mpluya&repo=tanzu-java-web-app-1.7"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=Mpluya&repo=tanzu-java-web-app-1.7'
